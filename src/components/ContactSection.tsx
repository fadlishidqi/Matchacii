  ...
  return (
    ...
    >
      ...
      <div className={`space-y-6 mb-8 transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        {/* WhatsApp Contact */}
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/50 hover:shadow-2xl hover:scale-105 transition-all duration-500 group">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <a 
                href="https://wa.me/6287742783440" 
                className="inline-block mt-2 px-4 py-2 bg-green-500 text-white font-semibold text-sm rounded-lg hover:bg-green-600 transition-colors"
              >
                +62 877-4278-3440
              </a>
            </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/50 hover:shadow-2xl hover:scale-105 transition-all duration-500 group">
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <a 
                ...
                className="inline-block mt-2 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-semibold text-sm rounded-lg hover:from-pink-600 hover:to-purple-600 transition-all"
              >
                @matchacii.smg
              </a>
            </div>
        ...
        <div className="text-center mt-6">
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 rounded-xl p-4">
            <p className="text-emerald-700 font-semibold text-sm">
              💬 <span className="font-bold">Konsultasi gratis</span> untuk memilih paket yang tepat!
            </p>
          </div>
        </div>
      </div>
